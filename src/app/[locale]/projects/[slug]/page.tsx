...
import { projectDocs } from "@/data/projectDocs"; // Asumiendo que esta es la ruta correcta
    ...
    <div className="min-h-screen bg-background pt-24 pb-32 transition-colors duration-300">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <header className="max-w-5xl mx-auto mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-black text-zinc-900 dark:text-white tracking-tighter leading-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-zinc-900 to-zinc-500 dark:from-white dark:to-gray-400">
            {project.title}
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div className="prose prose-lg dark:prose-invert prose-blue max-w-none p-8 rounded-3xl bg-white dark:bg-zinc-900/50 border border-black/5 dark:border-zinc-800 shadow-xl dark:shadow-none">
              <div
            ...
            <section>
              ...
              <div className="grid gap-6">
                {project.diagrams.map((diagram, i) => (
                  <div
                    key={i}
                    className="group relative rounded-2xl overflow-hidden border border-black/5 dark:border-white/10 bg-zinc-50 dark:bg-black/20"
                  >
            ...
            <div className="sticky top-24 p-6 rounded-3xl bg-white dark:bg-zinc-900/80 border border-black/5 dark:border-zinc-800 shadow-2xl dark:shadow-none">
              ...
              <div className="mt-8 pt-8 border-t border-black/5 dark:border-white/10">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <ExternalLink className="mr-2 h-4 w-4 text-blue-600" /> Ver
                    Demo en Vivo
                  </Button>
                  <Button
                    variant="outline"
                    className="w-full justify-start h-12 border-black/10 dark:border-white/10 hover:bg-zinc-50 dark:hover:bg-white/5 text-zinc-700 dark:text-gray-300 font-bold"
                  >
                    <Code className="mr-2 h-4 w-4 text-purple-600" /> Ver Código
                    en GitHub
                  </Button>
                </div>
              </div>
